...
<div style="max-width:560px; margin:0 auto;">
    ...
    <div style="margin-bottom:1.5rem;">
        ...
        <h1 style="font-size:1.6rem; font-weight:700; color:var(--text-main); margin-top:0.5rem;">Registrar Nuevo Cliente</h1>
        <p style="color:var(--text-muted); font-size:0.9rem; margin-top:0.25rem;">Completa los datos del cliente para agregarlo al sistema.</p>
    </div>
        ...
        <form method="POST" action="{{ route('clients.store') }}">
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:1.25rem; margin-bottom:1.25rem;">
                <div class="form-group">
                    ...
                    <input type="text" name="document_id" class="form-input" value="{{ old('document_id') }}"
